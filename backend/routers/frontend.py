...
async def hidden_admin_dashboard(secret_path: str):
    if not _secret_matches(secret_path, settings.ADMIN_SECRET_PATH): raise HTTPException(status_code=404, detail="Not found")
