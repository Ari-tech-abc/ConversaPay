...
class EmailService:
    ...
    def send_verification_email(self, to_email: str, token: str, user_name: str) -> bool:
        ...
        try:
            ...
            html_content = f"""
            <!DOCTYPE html><html><head><meta charset="utf-8"><title>Verify Your Email - ConversaPay</title></head>
            <body style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
              <div style="background:linear-gradient(135deg,#667eea,#764ba2);color:white;padding:30px;text-align:center;border-radius:10px 10px 0 0;"><h1>ברוך הבא ל-ConversaPay!</h1></div>
            ...
            params: resend.Emails.SendParams = {"from": f"{settings.EMAIL_FROM_NAME} <{settings.EMAIL_FROM_ADDRESS}>", "to": [to_email], "subject": "אמת את האימייל שלך - ConversaPay", "html": html_content}
    ...
    def send_password_reset_email(self, to_email: str, reset_link: str, user_name: str) -> bool:
        ...
        try:
            ...
            html_content = f"""
            <!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Reset Your Password - ConversaPay</title></head>
            <body style="font-family:Arial,sans-serif;line-height:1.6;color:#333;max-width:600px;margin:0 auto;padding:20px;">
              ...
              <div style="background:#f9f9f9;padding:30px;border:1px solid #ddd;border-top:none;border-radius:0 0 10px 10px;">
                <p>Hi {safe_name},</p><p>We received a request to reset your password for your ConversaPay account.</p><p>Click the button below to reset your password:</p>
              ...
              <p style="text-align:center;margin-top:20px;font-size:12px;color:#777;">© {datetime.utcnow().year} ConversaPay. All rights reserved.</p>
            </body></html>"""
            params = {"from": f"{settings.EMAIL_FROM_NAME} <{settings.EMAIL_FROM_ADDRESS}>", "to": [to_email], "subject": "Reset Your Password - ConversaPay", "html": html_content}
