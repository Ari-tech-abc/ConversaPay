...
class Settings(BaseSettings):
    ...
    PAYME_API_BASE_URL: str = "https://sandbox.payme.io"
    PAYME_GENERATE_PATH: str = "/api/generate-sale"
    PAYME_CLIENT_KEY: Optional[str] = None
    PAYME_SELLER_PAYME_ID: Optional[str] = None
    PAYME_SUCCESS_URL: Optional[str] = None
    PAYME_CANCEL_URL: Optional[str] = None
