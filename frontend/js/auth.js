...
(function() {
    ...
    // Absolute application routes. Never use relative *.html paths here: these
    // redirects also run from sub-paths such as /auth/callback, where a relative
    // target would resolve to /auth/dashboard.html and 404.
    ...
    function checkAuthState() {
        ...
        // Both the canonical route and the legacy *.html alias are accepted.
        if (isAuthenticated()) {
