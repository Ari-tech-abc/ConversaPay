 ...
 *
 * All redirects use absolute application routes (/dashboard, /login) rather
 * than relative .html file paths, so they resolve correctly from sub-paths
...
(function() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (getUrlParam('plan') === 'pro') {
                    ...
                    setTimeout(() => { window.location.href = DASHBOARD_ROUTE; }, 1000);
                }
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.requires_verification) {
                    ...
                    // Redirect to the verification landing page after 3 seconds
                    setTimeout(() => {
    ...
    function checkAuthState() {
        ...
        if (isAuthenticated() && AUTH_PAGE_PATHS.includes(window.location.pathname)) {
            window.location.href = DASHBOARD_ROUTE;
        }
    }
