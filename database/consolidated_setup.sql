...
-- Safe for production: no DROP TABLE, DROP FUNCTION, data deletion, or
-- destructive replacement. Run the base schema once, then use the additive
-- migrations in database/migrations for deployments.
